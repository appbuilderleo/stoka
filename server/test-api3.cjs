...
fetch('http://localhost:4000/api/products?store_id=28b92c0c-8965-4579-8376-63cd451d68e0', { headers: { Authorization: `Bearer ${token}` } }).then(r => r.json()).then(console.log).catch(console.error);
